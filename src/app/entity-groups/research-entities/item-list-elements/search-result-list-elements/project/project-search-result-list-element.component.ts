...
@Component({
  ...
  standalone: true,
  imports: [EscapeHtmlPipe, NgIf, RouterLink, ThemedThumbnailComponent, NgClass, TruncatableComponent, ThemedBadgesComponent, AsyncPipe, AdditionalMetadataComponent, MetricBadgesComponent, MetricDonutsComponent],
})
/**
