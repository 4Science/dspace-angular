...
@Component({
  ...
  standalone: true,
  imports: [EscapeHtmlPipe, NgIf, RouterLink, ThemedThumbnailComponent, NgClass, ThemedBadgesComponent, TruncatableComponent, TruncatablePartComponent, NgFor, AsyncPipe, MetricDonutsComponent, MetricBadgesComponent],
})
/**
