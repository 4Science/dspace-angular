...
xdescribe('SearchChartPieComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [TranslateModule.forRoot(), NoopAnimationsModule, FormsModule, SearchChartPieComponent],
      providers: [
      ...
      .overrideComponent(SearchChartPieComponent, {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SearchChartPieComponent);
  ...
  it('should create SearchChartPieComponent', () => {
