...
import { LayoutMetricRow } from '../metric-row/metric-row.component';
...
export class MetricsComponentsService {
   ...
   */
  getMatchingMetrics(metrics: Metric[], maxColumn: number, metricTypes: string[]): LayoutMetricRow[] {
  ...
  computeMetricsRows(itemMetrics: Metric[], maxColumn, metricTypes: string[]): LayoutMetricRow[] {
