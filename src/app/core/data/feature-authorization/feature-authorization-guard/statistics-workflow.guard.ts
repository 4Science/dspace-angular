...
export class StatisticsWorkflowGuard extends SingleFeatureAuthorizationGuard {
    constructor(
    ...
    getFeatureID(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<FeatureID> {
        return observableOf(FeatureID.CanViewWorkflowStatistics);
    }

    canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean | UrlTree> {
      return this.siteAuthorizationService.getSiteAuthorization(FeatureID.CanViewWorkflowStatistics);
    }
}
