...
export class DSONameService {
  ...
  getHitHighlights(object: any, dso: DSpaceObject, escapeHTML?: boolean): string {
    ...
    if (entityType === 'Person') {
      ...
      return this.firstMetadataValue(object, dso, 'organization.legalName', escapeHTML) || this.firstMetadataValue(object, dso, 'dc.title', escapeHTML) || this.translateService.instant('dso.name.untitled');
    }
